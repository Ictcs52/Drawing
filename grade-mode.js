(()=>{
  ...
  const P={
    ...
    p2:{
      english:['Vocabulary · ประโยคสั้น · อ่านเข้าใจ','sentences.html'],
    ...
    p3:{
      english:['Reading · Sentence · Grammar เบื้องต้น','sentences.html'],
  ...
  function apply(){
    ...
    if(missionButtons[0])missionButtons[0].onclick=()=>location.href=(g==='p2'||g==='p3')?'sentences.html':'vocabulary.html';
